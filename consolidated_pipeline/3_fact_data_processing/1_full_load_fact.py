...
# here, child is basically the gold_table, which is sb_fact_orders, means, we have to merge the sports bar data into the parent gold table - fact_orders
...
df_monthly = (
    ...
    # F.trunc("date", "MM") truncates the date column down to the start of the month
